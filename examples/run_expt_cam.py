...
def main():
    ...
    # use my own dataloader to control site prevalence

    from core.dataset import dataset_fn    
    from utils.config import load_config
    params = load_config('./classification_camelyon_no3.yaml')

    dataloader = dataset_fn(seed=config.seed, params_dict=params['dataset'])

    datasets['train']['loader'] = dataloader['train']
    datasets['val']['loader'] = dataloader['validation']
    datasets['test']['loader'] = dataloader['test']
